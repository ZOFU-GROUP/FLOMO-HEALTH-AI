...
function NotFoundComponent() {
  return (
    <div className="flex min-h-screen items-center justify-center warm-gradient px-4">
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center warm-gradient px-4">
      <div className="max-w-md text-center">
        <h1 className="text-xl font-display text-foreground">Something went off-balance</h1>
        <p className="mt-2 text-sm text-muted-foreground">
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Flomo Health AI — Your AI nutrition & wellness companion" },
      { name: "description", content: "Personalized nutrition, chronic-disease guidance, daily tracking and an AI health coach — built on your medical reality." },
      { property: "og:title", content: "Flomo Health AI — Your AI nutrition & wellness companion" },
      { property: "og:description", content: "Personalized nutrition, chronic-disease guidance, daily tracking and an AI health coach — built on your medical reality." },
